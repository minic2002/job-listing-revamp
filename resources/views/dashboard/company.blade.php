<x-dashboard-layout>
    <div class="px-6 mt-2 overflow-hidden rounded-lg border border-gray-200">
      <div class="flex justify-between items-center mb-10">
          ...
          <div class="">
              <p class="bg-hipe-dark-blue text-md py-2 px-6 text-white rounded-lg shadow-sm">Create company</p>
          </div>
      </div>
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <tr class="hover:bg-gray-50">
            <th class="flex gap-3 px-6 py-4 font-normal text-gray-900 items-center">
              <div class="relative h-16 w-16">
                <img
                  ...
                  src="/images/logo_hipe_black.png"
                  alt=""
                />
              </div>
              <div class="text-sm">
            ...
            <td class="px-6 py-4">Roof Deck Unit 1701 FLB Corporate Center, Cebu Business Park, Cebu City, 6000 Cebu</td>
            <td class="px-6 py-4">
              09565384835
            </td>
          </tr>
