        ...
        <div class="h-full   p-8">
            <div class=" rounded-lg shadow-xl pb-8 bg-white">
                <div class="w-full h-[250px]">
                    <img src="{{asset('images/ariana-swetener-tour.jpg')}}" class="w-full h-full rounded-tl-lg rounded-tr-lg object-cover object-center "  style="object-position: 50% 55% ;">
                </div>
                <div class="flex flex-col items-center -mt-20">
                    <img   src="{{  $userDetails->profile_url() }}" class="w-40 h-40 border-4 border-white rounded-full object-cover">
                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul class="mt-2 text-gray-700">
                            ...
                            <li class="flex  py-2">
                                ...
                                <span class="text-gray-700">{{ $userDetails->user->email}}</span>
                            </li>
                            <li class="flex py-2">
